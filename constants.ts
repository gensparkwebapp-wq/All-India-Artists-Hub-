...
// geoLat/geoLng are real coordinates for Distance calculation
export const DIRECTORY_ARTISTS: (DirectoryArtist & { geoLat?: number, geoLng?: number })[] = [
  { 
    ...
    skills: ['Bollywood', 'Sufi', 'Classical'], startingPrice: 15000, verified: true, 
    lat: 40, lng: 30, geoLat: 26.8416, geoLng: 75.8000, // Near Sanganer, Jaipur
    description: "Professional playback singer with 5 years experience.", reviews: 120,
  ...
  { 
    ...
    skills: ['Kathak', 'Contemporary', 'Bollywood'], startingPrice: 20000, verified: true, 
    lat: 60, lng: 25, geoLat: 19.0596, geoLng: 72.8295, // Bandra
    description: "Available for stage shows and wedding choreography.", reviews: 85,
  ...
  { 
    ...
    skills: ['Vocal Recording', 'Mixing', 'Mastering'], startingPrice: 1000, verified: true, 
    lat: 25, lng: 35, geoLat: 28.5494, geoLng: 77.2001, // Hauz Khas
    description: "State of the art recording facility in South Delhi.", reviews: 45,
  ...
  { 
    ...
    skills: ['Method Acting', 'Theatre', 'Voice Over'], startingPrice: 5000, verified: false, 
    lat: 62, lng: 26, geoLat: 19.1136, geoLng: 72.8697, // Andheri
    description: "Theatre artist looking for serious roles.", reviews: 20,
  ...
  { 
    ...
    skills: ['EDM', 'Wedding DJ', 'Sound Setup'], startingPrice: 25000, verified: true, 
    lat: 65, lng: 30, geoLat: 18.5204, geoLng: 73.8567, // Pune
    description: "Best DJ in town for your parties.", reviews: 210,
  ...
  { 
    ...
    skills: ['Folk', 'Bhajan'], startingPrice: 8000, verified: true, 
    lat: 41, lng: 31, geoLat: 26.9390, geoLng: 75.7533, // Jhotwara, Jaipur
    description: "Specialist in Rajasthani Folk music.", reviews: 30,
  ...
  { 
    ...
    skills: ['Wedding', 'Portfolio', 'Event'], startingPrice: 35000, verified: true, 
    lat: 50, lng: 28, geoLat: 24.5854, geoLng: 73.7125, // Udaipur
    description: "Capturing moments that last forever.", reviews: 500,
  ...
  { 
    ...
    skills: ['Live Band', 'Orchestra'], startingPrice: 50000, verified: false, 
    lat: 45, lng: 25, geoLat: 26.3477, geoLng: 73.0485, // Mandore
    description: "Complete live band for weddings.", reviews: 15,
  ...
  { 
    ...
    skills: ['Hip Hop', 'Salsa'], startingPrice: 1500, verified: true, 
    lat: 22, lng: 36, geoLat: 28.6757, geoLng: 77.2219, // Civil Lines
    description: "Learn dance from the experts.", reviews: 60,
  ...
  { 
    ...
    skills: ['Keyboard', 'Piano'], startingPrice: 5000, verified: false, 
    lat: 48, lng: 35, geoLat: 25.1825, geoLng: 75.8242, // Ladpura
    description: "Freelance keyboard player.", reviews: 8,
   ...
   { 
    ...
    skills: ['Dubbing', 'Music Production'], startingPrice: 1200, verified: true, 
    lat: 39, lng: 29, geoLat: 26.9855, geoLng: 75.8513, // Amer
    description: "Affordable recording studio in Amer.", reviews: 40,
  ...
  { 
    ...
    skills: ['Bridal', 'Party', 'HD Makeup'], startingPrice: 12000, verified: true, 
    lat: 15, lng: 30, geoLat: 30.6946, geoLng: 76.7381, // Mohali
    description: "Certified makeup artist.", reviews: 95,
